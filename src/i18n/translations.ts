...
export const translations: Record<'en' | 'ar', Translation> = {
  en: {
    ...
    footer: {
      ...
      copyright: "© Copyright 2025, All Rights Reserved by eeina",
      discover_description: "Discover both timeless classics and exciting new dishes with EEINA Food, where our users' top-rated recipe categories guide you to the best of every cuisine"
    }
  },
  ar: {
    nav: {
    ...
    footer: {
      ...
      copyright: "© حقوق الطبع والنشر 2025 جميع الحقوق محفوظة EEINA",
      discover_description: "اكتشف الأطباق الكلاسيكية الخالدة والأطباق الجديدة المثيرة مع إيينا للطعام، حيث تقودك فئات الوصفات الأعلى تقييماً من مستخدمينا إلى أفضل ما في كل مطبخ"
    }
  }
};
